...
public class ParsedPage{
 	...
 	public List getApp_links(){
		return this.app_links;
	}
	public void setApp_links(List app_links){
	...
	public void setAuthors(List authors){
 	...
 	public Number getCache_age(){
		return this.cache_age;
	}
	public void setCache_age(Number cache_age){
